...
alias configure="cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug -DCMAKE_INSTALL_PREFIX=$ROOT_DIR/build/test-install -DCPACK_PACKAGE_FILE_NAME=FracTool-Debug-$OSTYPE"
